        ...
        return resolve(
          arr.map((x,i) => {
            return obj = {
              ...
              sentAt:   moment.unix(JSON.parse(res[i].args.sendTime)).format('dddd, MMMM Do, YYYY HH:mm:ss'),
              dueAt:    moment.unix(JSON.parse(res[i].args.dueAt)).format('dddd, MMMM Do, YYYY HH:mm:ss'),
