...
IF RE DEPLOYING, DOM'T SET A CUSTOM GAS PRICE - ORACLIZE SORT IT OUT APPARENTLY
ANY MORE USEFUL FUNCTIONS TO ADD?
LOOK AT TXS ON CHAIN TO SEE THE PRICE OF THE CALLBACK FUNCTION
...
First call costs 9ish dollars in gas!!
...
*/
  ...
  contract Etheraffle is etheraffleUpgrade, FreeLOTInterface, usingOraclize {
      ...
      uint    public rafEnd       = (5 * 24*60*60) + (17*60*60) + (25*60);//500400;
      ...
      string randomStr2 = "\",\"params\":{\"n\":\"6\",\"min\":1,\"max\":49,\"replacement\":false,\"base\":10,\"apiKey\":${[decrypt] BCmNEbhO0q2HKhMufSnqImGpUn+BERDdvHxtMPJ4YQTYYi1TFw5AdWGLAtK8yuMHDfL3p8VfuONGKHeBbDYrtJmsJUTZ3/TpLW0wZfM8XWn8xBmP2VKHWNPC1Xlp29gpPqHu2Wee40msmAoKqVNPtnhaWeL+BPq4rg==}}']";
      string apiStr1 = "[URL] ['json(https://etheraffle.com/api/e).m','{\"r\":\"";
      string apiStr2 = "\",\"k\":${[decrypt] BOJKFrXo6jw+ggN5dWtU0jgZbM1B2p6jV/nmqk7Y9hGXGCrV9yBGefoJsK/HnOBHLibEitcihS5sazdELMwRAwo7Ki+9u/511kI4d7SkVMT8NhHXtGGtj1GVHksIyTvU/jL8Imf1}}']";
      ...
      */
      ...
      function Etheraffle(address _freeLOT, address _dsbrs, address _msig, address _ethRelief) payable {
          ...
          uint delay   = 1518283500;//(week * weekDur) + birthday + rafEnd + resultsDelay;
      ...
      function withdrawWinnings(uint _week, uint _entryNum) onlyIfNotPaused external {
          ...
          (
              ...
              now - raffle[_week].timeStamp > weekDur &&
      ...
      function __callback(bytes32 _myID, string _result) onlyIfNotPaused {
          ...
          if(qID[_myID].isRandom == true){//460,241 gas per etherscan tx: 0xf4a93ae7e1620adfe619b043128f9fb70016a43da1313f64a943354a4f5d683b
              ...
              uint delay = 1518284100;//(getWeek() * weekDur) + birthday + rafEnd + resultsDelay;//by now the week should be next...
