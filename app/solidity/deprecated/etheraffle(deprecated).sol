/*
Haven't called upgrade on this on yet to reclaim the ether!!!
*/
...
*/
  ...
  contract Etheraffle is etheraffleUpgrade, FreeLOTInterface, usingOraclize {
      ...
      string randomStr2 = "\",\"params\":{\"n\":\"6\",\"min\":1,\"max\":49,\"replacement\":false,\"base\":10,\"apiKey\":${[decrypt] BAuGUfm5W/rtFurdhRXuG+ELQi9672PsnSLnZpDZxR7cewJc3mBZI47XeoZ5ZAxKK79F2VHw4uWRa890EUW8PqjMfR7iWXr3q+P2s+qxwQ9+rdQ9p4X2x0fr6MV7MCwhHFXy1YILAjU/wig3GmcJ/RItZxH8w83hTQ==}}']";
      //change following string to have  /e per new api
      string apiStr1 = "[URL] ['json(https://etheraffle.com/api/e).m','{\"r\":\"";
      string apiStr2 = "\",\"k\":${[decrypt] BHBgzBUoWUyI/IZFqfhl6NVA8hYPyIVEHRJKMfp3989G0L0Rh5gmvJ+ki9FUGgCPsip6IpS4N1km5nvGQ/rT54m3k+pDqGHTP5pPIPDrTFFc1mR1bQ0Dkh4QhvTxNbQGodRDSfRF}}']";
...
0x51d8f4b7f3028058957adA59d764B370C016E7d6
