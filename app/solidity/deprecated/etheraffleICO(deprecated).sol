...
* TODO: Publish the LOT token contract first, then this, then transfer all LOT tokens to this contract.
*
...
*
*
* String: uint _start, address _LOT, address _freeLOT, address _msig
* READY FOR MAIN NET Deploy string:
1518393600, "0x42f3659c55b5a10e556c2da7e613c6f741ddb39f","0x4c388dce25665ea602b92f15718ca278bba45a9a","0x97f535e98cf250CDd7Ff0cb9B29E4548b609A0bd"
*/
...
contract EtheraffleICO is EtheraffleLOT {
    ...
    uint public constant bonusLOT     = 2000 * 10 ** 6;
    ...
    uint public constant maxWeiTier1 = 1500  * 10 ** 18;
    uint public constant maxWeiTier2 = 4500  * 10 ** 18;
    uint public constant maxWeiTier3 = 13500 * 10 ** 18;
    ...
    */
    function EtheraffleICO(uint _start, address _LOT, address _freeLOT, address _msig) public {
        etheraffle     = _msig;
        crowdSaleStart = _start;//Mon Feb 12th 1518393600
        tier1End       = _start   + (10 * 86400);
        tier2End       = tier1End + (20 * 86400);
        tier3End       = tier2End + (31 * 86400);//ends on Alex's Birthday!
        withdrawBefore = tier3End + (14 * 86400);//ends on Abbie's Birthday!
    ...
    */
    function transferLOT() onlyEtheraffle external {
    ...
    */
    ...
    function getTier() external constant returns (uint) {
        if(now <= crowdSaleStart) {
            ...
            return 3;
        } else if(now <= withdrawBefore) {// ∴ Withdrawal period open
            return 4;
        } else if(now > withdrawBefore) {// ∴ Ico over
            return 5;
        }
    }
    */
