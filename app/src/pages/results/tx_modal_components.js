  ...
  <ScreenContext.Consumer>
    {({FAQ}) => (
      <React.Fragment>
        ...
        {props.freeGo
          ? <p className='justify'>
              Click the hash above to watch your transaction being mined in to the block chain! When your transaction is received by Etheraffle's smart-contract it will send you a <span className={`styledSpan screen${props.screenIndex}`}>FreeLOT</span> coupon! You can use this to enter any future raffle for free! For more information, <span className={`styledSpan screen${props.screenIndex}`} style={{'cursor':'pointer'}} onClick={FAQ} >see the FAQ</span>.<br/><br/>Please be patient whilst this is occuring. If after 24 hours you have not received your coupon, please contact support quoting your ethereum address and this transaction hash.
            </p>
          : <p className='justify'>
              Click the hash above to watch your transaction being mined in to the block chain! When your transaction is received by Etheraffle's smart-contract it will send your ETH directly into your account!<br/><br/>Please be patient whilst this is occuring. If after 24 hours you have not received your ETH, please contact support quoting your ethereum address and this transaction hash.
            </p>
        }
      </React.Fragment>
    )}
