    ...
    return(
      <div>
        ...
        <p className="justify">
          ...
          This will pop-up your ethereum browser's transaction window, which will be pre-filled in with the correct details. All blockchain transactions require a fee paid in the form of gas. Etheraffle's smart-contracts are designed to be as gas efficient as possible whilst maintaining total security, meaning no one can withdraw your winnings except you. The gas is the cost of this security. At current ether prices, the fee is approximately $0.50. After your transaction is submitted and mined, Etheraffle's smart-contract will pay your winnings directly to your ethereum address. The "Claim Prize" button will have turned into "Prize Claimed", and a tooltip will appear over it with the details of your prize claim:
        </p>
